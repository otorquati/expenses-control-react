...
describe('Login', () => {
  // Testa se o campo de email não está vazio
  ...
  // Testa se o campo de email foi preenchido
  ...
  // Testa se o campo de email foi modificado
  test('given email, when field not changed, then hide required error message', async () => {
   ...
   // Testa se o campo de email é inválido
   ...
   // Testa se o campo de Senha não está vazio
